        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="relative w-full max-w-sm">
              <div className="rounded-lg overflow-hidden border-2 border-sky-500/30 shadow-xl shadow-sky-500/10 group">
                <img 
              ...
              <div className="absolute inset-0 bg-gradient-to-tl from-sky-500/30 to-emerald-400/30 rounded-lg filter blur-xl -z-10"></div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex justify-center mb-8">
              {stats.map((stat, index) => (
                <motion.div 
                  key={index}
                  className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-lg border border-sky-500/20 shadow-lg"
                  initial={{ opacity: 0, y: 20 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 0.4, delay: 0.3 + index * 0.1 }}
                >
                  <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-emerald-400">
                    {stat.value}
                  </p>
